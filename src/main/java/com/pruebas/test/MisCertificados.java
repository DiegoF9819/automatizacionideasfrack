...
public class MisCertificados extends Base {
    ...
    private By misCertificadosLink = By.xpath("//p[text()='Mis Certificados']"); // Enlace a Mis Certificados

    public MisCertificados(WebDriver driver) {
        super(driver);
    }
    ...
    public void ejecutarLista() {
        ...
        // Hacer clic en "Mis Certificados"
        clickMisCertificados();
    }
    ...
    private void clickMisCertificados() {
        WebDriverWait wait = new WebDriverWait(getDriver(), Duration.ofSeconds(30));
        try {
            WebElement misCertificadosElement = wait.until(ExpectedConditions.elementToBeClickable(misCertificadosLink));
            misCertificadosElement.click();
        } catch (Exception e) {
            System.out.println("No se pudo hacer clic en 'Mis Certificados': " + e.getMessage());
        }
    }
}
