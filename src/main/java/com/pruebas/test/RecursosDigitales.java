...
public class RecursosDigitales extends Base {
    ...
    public RecursosDigitales(WebDriver driver) {
        super(driver);
    }
    ...
    public void ejecutarLista() {
        ...
        esperarCarga(); // Puedes implementar esta función si necesitas verificar algún elemento después del login
    }
